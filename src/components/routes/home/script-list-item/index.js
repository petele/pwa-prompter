...
const ScriptListItem = ({ scriptID, idx, title, snippet, lastUpdated, hasStar, readOnly, onDelete, onStar }) => {
  ...
  return (
    <div class={style.item}>
      <button class={style.delete} type="button" aria-label="delete" onClick={clickDelete} title="Delete">
      ...
      <button class={getStarButtonStyle()} type="button" aria-label="delete" onClick={clickStar} title="Star">
        {/* Outline */}
