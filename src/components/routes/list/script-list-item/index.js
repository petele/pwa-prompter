      ...
      <div class="card-footer text-muted d-flex">
        ...
        <div class="btn-group position-absolute top-0 end-0" role="group">
          {hasStar
            ...
            :
            <button type="button" class="btn btn-outline-primary btn-sm" aria-label="Add star" onClick={clickStar} title="Add star">
              <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 0 24 24" width="48px" fill="#ffffff">
          ...
          <button type="button" class="btn btn-danger btn-sm" aria-label="delete" onClick={clickDelete} title="Delete">
            <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 0 24 24" width="48px" fill="#FFFFFF">
              <path d="M0 0h24v24H0V0z" fill="none" />
